...
const SearchPanel = () => {
  const { products, categories, closeRight } = useCustomContext();
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 z-20 flex justify-end">
      <div className="bg-white w-1/3 p-6 h-full shadow-lg overflow-auto">
        <button onClick={closeRight} className="text-black mb-4">
          Close
        </button>
        <input
          type="text"
