    ...
    <div>
      ...
      <div className="mx-auto text-center px-8 md:px-0">
        <form className="font-opensans mx-auto md:max-w-[478px] w-auto mt-[44px]">
          ...
          <br />
          <button  className="mt-[24px]  text-[12px] md:text-[14px] font-semibold bg-primary text-white px-[0px] tracking-[1.5px] py-[18px] w-full" type="button" onClick={handleLogin}>
            Login
          </button>
        </form>
      </div>
